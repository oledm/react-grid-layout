...
export function synchronizeLayoutWithChildren(initialLayout: Layout, children: ReactChildren,
  ...
  React.Children.forEach(children, (child: React.Element<any>, i: number) => {
    ...
    console.log('exists', exists, 'key', child.key)
    if (exists) {
      layout[i] = cloneLayoutItem(exists);
//      if (!exists.isHidden) {
//        layout = layout.concat(cloneLayoutItem(exists))
//      } else {
//        console.warn('layout', exists, 'is hidden')
//      }
    } else {
...
//        console.log('cloned item:', child.key, 'is it hidden:', child.props['data-grid'].isHidden)
//        if (!child.props['data-grid'].isHidden) {
//          layout = layout.concat(cloneLayoutItem({...g, i: child.key}))
//        }
      } else {
//        console.log('cloned item:', child.key, 'is it hidden:', child.props.isHidden)
//        console.log('cloned item:', child.key, 'is it hidden:', child)
//        if (!child.props.isHidden) {
//          layout = layout.concat(cloneLayoutItem({w: 1, h: 1, x: 0, y: bottom(layout), i: child.key || "1"}))
//        }
//        console.log('clone item', child.key)
